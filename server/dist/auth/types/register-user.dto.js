...
exports.UserRegiserDTO = void 0;
const class_transformer_1 = require("class-transformer");
const class_validator_1 = require("class-validator");
class UserRegiserDTO {
}
exports.UserRegiserDTO = UserRegiserDTO;
__decorate([
    (0, class_validator_1.IsString)({ message: 'The name should be a string' }),
    (0, class_validator_1.Matches)(/^[^!@#$%^&*()=0-9/\\}{_+;:"'><.,\][]+$/, {
        message: 'The name contains only letters and spaces',
    }),
    (0, class_validator_1.MinLength)(8, { message: 'The name must have at least 8 characters' }),
    (0, class_validator_1.MaxLength)(20, {
        message: 'The name can only contain a maximum of 20 characters',
    }),
    (0, class_transformer_1.Expose)(),
    __metadata("design:type", String)
], UserRegiserDTO.prototype, "displayName", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsEmail)(),
    (0, class_transformer_1.Expose)(),
    __metadata("design:type", String)
], UserRegiserDTO.prototype, "email", void 0);
__decorate([
    ...
    (0, class_transformer_1.Expose)(),
    __metadata("design:type", String)
], UserRegiserDTO.prototype, "password", void 0);
